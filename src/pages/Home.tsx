...
// Assets
const heroBg = "/attached_assets/generated_images/modern_high-tech_electronics_repair_workbench_background.png";
const heroBg1 = "/attached_assets/generated_images/professional_iphone_repair_workspace_close_up_black_and_white.png";
const iconIphone = "/attached_assets/generated_images/iphone_repair_icon_style_illustration.png";
    ...
    <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button asChild className="bg-primary text-black hover:bg-primary/90 font-semibold rounded-full px-6">
          {/* Use 'tel:' followed by the number without spaces or dashes */}
          <a href="tel:+971563231520">
            Call Now
          </a>
        </Button>
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col p-4 gap-4">
            <a href="#home" className="text-sm font-medium hover:text-primary" onClick={() => setIsOpen(false)}>Home</a>
            <a href="#services" className="text-sm font-medium hover:text-primary" onClick={() => setIsOpen(false)}>Services</a>
            <a href="#why-us" className="text-sm font-medium hover:text-primary" onClick={() => setIsOpen(false)}>Why Us</a>
            <a href="#contact" className="text-sm font-medium hover:text-primary" onClick={() => setIsOpen(false)}>Contact</a>
          </div>
        </motion.div>
      )}
    </nav>
  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroBg} alt="Electronics Workbench" className="w-full h-full object-cover opacity-50" />
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          <div className="inline-block px-4 py-1.5 mb-6 border border-primary/30 rounded-full bg-primary/10 backdrop-blur-sm">
            <span className="text-primary text-sm font-semibold tracking-wide uppercase">Best Apple Service Center in UAE</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-display font-bold mb-6 leading-tight">
            Expert Repair for <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Your Valuable Devices</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10">
            We don't just repair; we restore. Specialized in iPhone, iPad, MacBook, and Apple Watch repairs with original parts and guaranteed quality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 font-medium text-lg h-14 px-8">
              Free Diagnostics
            </Button>
          </div>
        </motion.div>
...
const Services = () => {
  const services = [
    { title: "iPhone Repair", icon: iconIphone, desc: "Screen, battery, and motherboard repairs." },
    { title: "iPad Repair", icon: iconIpad, desc: "Glass replacement, charging issues, and more." },
    { title: "MacBook Repair", icon: iconMacbook, desc: "Keyboard, logic board, and screen services." },
    { title: "Apple Watch Repair", icon: iconWatch, desc: "Glass replacement and sensor repairs." },
  ];
    ...
    <section id="services" className="py-24 bg-background relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground">Specialized services for all your Apple devices</p>
        </motion.div>
              ...
              <Card className="bg-card/50 border-white/5 hover:border-primary/50 transition-colors duration-300 group h-full">
                <CardContent className="p-6 flex flex-col items-center text-center pt-10">
                  <div className="relative w-24 h-24 mb-6 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <img src={service.icon} alt={service.title} className="relative z-10 w-full h-full object-contain" />
                  </div>
...
const WhyChooseUs = () => {
  const reasons = [
    { title: "Free Diagnostics", icon: <CheckCircle className="w-6 h-6 text-primary" />, desc: "We check hardware and software issues for free." },
    { title: "Quick Repair Process", icon: <Clock className="w-6 h-6 text-primary" />, desc: "Most repairs finished in under 25 minutes." },
    { title: "30-Day Warranty", icon: <ShieldCheck className="w-6 h-6 text-primary" />, desc: "Guarantee on almost all our repairs." },
    { title: "High Quality Parts", icon: <Wrench className="w-6 h-6 text-primary" />, desc: "Original Apple parts for lasting performance." },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">Why Choose Our <br /><span className="text-primary">Service Center?</span></h2>
            <p className="text-muted-foreground text-lg mb-8">
              There are many valid reasons why you should choose us to take care of your valuable device. 
              The most important is that you don't just want a repair. We are the best iPhone repair specialist.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {reasons.map((reason, index) => (
                <div key={index} className="flex items-start gap-4 p-4 rounded-lg bg-background/50 border border-white/5 hover:border-primary/30 transition-colors">
          ...
          >
            <img src={heroBg1} alt="Tech Lab" className="absolute inset-0 w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent" />
            <div className="absolute bottom-0 left-0 p-8">
              <div className="bg-primary text-black font-bold px-4 py-2 rounded mb-2 inline-block">Trusted by Thousands</div>
              <h3 className="text-2xl font-bold text-white">Your device is in safe hands.</h3>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Our Promise</h2>
          <p className="text-muted-foreground">Commitment to excellence in every repair</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="text-5xl font-display font-bold text-white/5 absolute top-2 right-4">{step.number}</div>
...
const Mockup = () => {
  ...
  return (
    ...
    <div className={`min-h-screen bg-[${theme.bg}] text-white overflow-hidden relative font-sans`}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-24 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 h-full">
        ...
        <div className="flex-1 flex flex-col items-start space-y-8 z-10 text-center lg:text-left">
          <div className="space-y-4">
            ...
            <h2 className={`text-[${theme.neonPrimary}] font-bold tracking-widest text-sm uppercase`}>
              Repair & Care Services
            </h2>
            <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight tracking-tight">
              Revive Your <br />
              {/* UPDATED: Gradient text to neon green range */}
              <span className={`text-white bg-clip-text bg-gradient-to-r from-[${theme.neonLight}] to-[${theme.neonPrimary}]`}>
                Digital Life
              </span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
            ...
            <button className={`bg-[${theme.neonPrimary}] text-white hover:bg-[${theme.neonLight}] px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(15,255,80,0.4)]`}>
              <a href="tel:+971563231520">
               Book a Repair
              </a>
            </button>
            {/* UPDATED: Secondary button borders and text to neon green */}
            <button className={`border border-[${theme.neonPrimary}]/30 text-[${theme.neonPrimary}] hover:bg-[${theme.neonPrimary}]/10 px-8 py-4 rounded-full font-bold text-lg transition-all`}>
              Our Pricing
            </button>
          </div>
              ...
              <div className="relative w-full h-full flex flex-col">
                ...
                <div className="absolute top-0 w-full h-[44px] flex justify-between items-center px-6 z-30 text-white text-sm font-medium select-none">
                  ...
                  <div className="flex gap-2">
                    {/* Signal */}
                    <svg width="18" height="12" viewBox="0 0 22 13" fill="currentColor"><rect x="0.5" y="9" width="3" height="3.5" rx="1"/><rect x="5.5" y="6" width="3" height="6.5" rx="1"/><rect x="10.5" y="3" width="3" height="9.5" rx="1"/><rect x="15.5" y="0" width="3" height="12.5" rx="1" opacity="0.3"/></svg>
                    {/* Wifi */}
                    <svg width="16" height="12" viewBox="0 0 19 13" fill="currentColor"><path d="M9.5 11.5C10.05 11.5 10.5 11.05 10.5 10.5C10.5 9.94 10.05 9.5 9.5 9.5C8.94 9.5 8.5 9.94 8.5 10.5C8.5 11.05 8.94 11.5 9.5 11.5Z"/><path d="M3.07 7.5C5.38 5.18 9.61 5.18 11.92 7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M0.92 5C4.82 1.1 13.17 1.1 17.07 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>
                    {/* Battery */}
                    <svg width="22" height="12" viewBox="0 0 25 13" fill="currentColor"><rect x="1" y="2" width="19" height="9" rx="2" stroke="currentColor" strokeWidth="1.2" fill="none"/><rect x="21" y="5" width="2.5" height="3" rx="1"/><rect x="3" y="4" width="15" height="5" rx="1"/></svg>
                  </div>
                </div>
                ...
                <main className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4 pt-20">
                  ...
                  <button className="bg-[#39FF14] text-black font-bold py-3 px-8 rounded-full shadow-[0_0_20px_rgba(57,255,20,0.5)] hover:shadow-[0_0_30px_rgba(57,255,20,0.8)] hover:scale-105 transition-all duration-300">
                    <a href="#services" className="text-sm font-medium">View Products</a>
                  </button>
                </main>
    ...
    <section className="py-12 border-t border-white/5 bg-card/20">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        ...
        <p className="text-muted-foreground text-sm">
          We prioritize your data privacy. Your device's information is treated with strict confidentiality and is never shared with third parties. We value the trust you place in us.
        </p>
      </div>
    </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-card/20 border border-white/5 backdrop-blur-sm rounded-[2.5rem] p-8 md:p-16 text-white overflow-hidden relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 relative z-10">
              ...
              <div>
                <h2 className="text-4xl font-bold mb-6">Visit Our Service Center</h2>
                {/* Changed text-slate-400 to text-muted-foreground */}
                <p className="text-muted-foreground mb-10 text-lg">
                  Ready to fix your device? Visit us today or give us a call. We are open and ready to help.
                </p>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">17 18 St Al Murar, Dubai, UAE</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground hover:text-white transition-colors cursor-pointer" onClick={() => window.location.href = 'tel:+971563231520'}>
                        +971 56 323 1520
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground hover:text-white transition-colors cursor-pointer" onClick={() => window.location.href = 'mailto:hr@saifphone.com'}>
                        hr@saifphone.com
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-2 border border-white/10 h-full min-h-[400px] relative overflow-hidden group">
                  <div className="w-full h-full rounded-2xl overflow-hidden relative">
                    ...
                    <iframe 
                      ...
                      // marginHeight="0" 
                      // marginWidth="0" 
                      // Using the address from the text: 17 18 St Al Murar, Dubai, UAE
                      src="https://maps.google.com/maps?q=17%2018%20St%20Al%20Murar%2C%20Dubai%2C%20UAE&t=&z=15&ie=UTF8&iwloc=&output=embed"
                      // Adding grayscale and invert filters to make the standard Google Map look "Dark Mode"
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-black/80 backdrop-blur-md border border-white/10 text-white p-4 rounded-xl shadow-2xl">
                      <div className="flex justify-between items-center">
                        ...
                        <a 
                          href="https://www.google.com/maps?q=17+18+St+Al+Murar,+Dubai,+UAE" 
                          target="_blank" 
                          rel="noreferrer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="hover:text-primary transition-colors cursor-pointer">iPhone Repair</li>
              <li className="hover:text-primary transition-colors cursor-pointer">iPad Repair</li>
              <li className="hover:text-primary transition-colors cursor-pointer">MacBook Repair</li>
              <li className="hover:text-primary transition-colors cursor-pointer">Apple Watch Repair</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <a href="mailto:hr@saifphone.com" className="hover:text-white transition-colors">hr@saifphone.com</a>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
                <Phone className="w-5 h-5 text-primary" />
                <a href="tel:+971563231520" className="hover:text-white transition-colors">+971 56 323 1520</a>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground">
                <MapPin className="w-5 h-5 text-primary mt-1" />
                <span className="hover:text-white transition-colors">17 18 St Al Murar, Dubai, UAE</span>
              </li>
            </ul>
          </div>
        </div>
